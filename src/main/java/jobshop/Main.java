...
import jobshop.solvers.GloutSolver;
...
public class Main {
    ...
    static {
        ...
        solvers.put("SPT", new GloutSolver(GloutSolver.Priority.SPT));
        solvers.put("LRPT", new GloutSolver(GloutSolver.Priority.LRPT));
        solvers.put("EST_SPT", new GloutSolver(GloutSolver.Priority.EST_SPT));
        solvers.put("EST_LRPT", new GloutSolver(GloutSolver.Priority.EST_LRPT));
        solvers.put("descent", new DescentSolver());
        solvers.put("taboo", new TabooSolver(100, 10));
    }
